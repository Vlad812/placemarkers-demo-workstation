...
- [Что делает (кратко)](#что-делает-кратко)
- [Структура:](#структура)
...
- [Что демонстрирует проект:](#что-демонстрирует-проект)
  ...
  - [2. Паттерны на уровне приложения (внутри сервисов)](#2-паттерны-на-уровне-приложения-внутри-сервисов)
...
- [Полная схема архитектуры](#полная-схема-архитектуры)
  ...
  - [Инициализация PostgreSQL (\`common-services/postgresql/Init\`)](#инициализация-postgresql-common-servicespostgresqlinit)
- [Установка и запуск](#установка-и-запуск)
- [Как работает make app-setup (Пайплайн)](#как-работает-make-app-setup-пайплайн)
...
6. **Остановка проекта**:
   ...
   make app-down
   ```
   > Эта команда остановит и удалит контейнеры вместе с их volume'ами (базы данных будут очищены).

---

## Как работает make app-setup (Пайплайн)
